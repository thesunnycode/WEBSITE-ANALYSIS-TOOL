          ...
          >
            ...
            >
              <p className="text-xl text-white/80 leading-relaxed">
                Join our platform and get access to powerful website analysis
                tools and real-time monitoring features.
              </p>
              <p className="text-xl text-white/80 leading-relaxed">
                Create your account now and start optimizing your website's
            ...
            <Card className="p-8 space-y-6 bg-black/30 backdrop-blur-xl border border-white/10 shadow-2xl shadow-primary/20">
              ...
              >
                <p className="text-white/60">
                  ...
                  <Link
                    href="/login"
                    className="text-white hover:text-white/90 transition-colors font-medium hover:underline underline-offset-4"
                  >
                    Sign in
                  </Link>
                </p>
