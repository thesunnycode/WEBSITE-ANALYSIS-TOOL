...
export default function HistoryPage() {
  ...
  const getSummaryStats = () => {
    ...
    const avgScore =
      analyses
        .map(getHealthScore)
        .filter(Boolean)
        .reduce((sum, score) => sum + (score || 0), 0) / completed || 0;
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] p-8 rounded-xl border border-white/5">
        <motion.div
    ...
    <div className="p-8">
      ...
      >
        ...
        <Card className="bg-[#151F32]/80 border-[#2D3748] p-4">
          ...
          <TimelineChart data={analyses} />
        </Card>

        {/* Advanced Filters */}
        <div className="bg-[#151F32]/80 border border-[#2D3748] rounded-lg p-4">
          <div className="flex items-center justify-between mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-[#121826] border border-[#2D3748] rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30 transition-all"
              />
            </div>
            ...
            <DateRangePicker
              ...
              className="bg-[#121826] border border-[#2D3748] rounded-lg"
            ...
            {showFilters && (
              ...
              >
                <div className="pt-4 border-t border-[#2D3748]">
                  <div className="mb-4">
                    <h4 className="text-sm text-gray-400 mb-2">Domain Tags</h4>
                      ...
                      {savedFilters.length === 0 ? (
                        ...
                        savedFilters.map((filter, index) => (
                          <button
                            ...
                            className="px-3 py-1 rounded-full text-sm bg-white/5 text-gray-300 border border-white/10 hover:bg-white/10 transition-colors"
                          >
                            {filter.name}
                          </button>
                        ))
        ...
        <AnimatePresence>
          {selectedItems.length > 0 && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -10 }}
              className="flex items-center justify-between p-4 bg-white/10 backdrop-blur-sm border border-white/10 rounded-lg shadow-glass"
            >
        ...
        {filteredAnalyses.length === 0 ? (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="flex flex-col items-center justify-center py-16 bg-white/10 backdrop-blur-sm border border-white/10 rounded-lg shadow-glass"
          >
            <Image
          ...
          <div className="overflow-x-auto bg-white/10 backdrop-blur-sm border border-white/10 rounded-lg shadow-glass">
                ...
                <tr className="text-left border-b border-[#2D3748]">
                  <th className="p-4 w-10">
                    <input
                      ...
                      className="rounded border-[#2D3748] focus:ring-blue-500"
                    />
                  </th>
                  {visibleColumns.url && (
                    <th
                          ...
                          <td className="p-4">
                            {healthScore !== null ? (
                              <div className="flex items-center gap-3">
                                <ScoreGauge score={healthScore} size={40} />
                                <div>
                                  <span
                            ...
                            <div className="p-4 border-t border-[#2D3748]">
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                  ...
                                  {analysis.history ? (
                                    <SparklineChart data={analysis.history} />
                                  ) : (
                                    <p className="text-gray-500 text-sm">
